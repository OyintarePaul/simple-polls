  ...
  return (
    <div className="space-y-8 max-w-5xl mx-auto py-10 px-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {[...Array(4)].map((_, i) => (
          <Card key={i} className="p-5 space-y-4 shadow-sm border-border/60">
      ...
      <Card className="p-6 sm:p-8 space-y-6 shadow-sm !rounded-2xl">
        ...
        <div className="space-y-4 pt-2">
          {[...Array(3)].map((_, i) => (
            <div key={i} className="border border-border bg-muted/30 p-5 rounded-xl flex items-center justify-between shadow-sm">
